...
def confirm_close():
    return messagebox.askyesno(
        message="You have unsaved changes. Are you sure you want to close the tab?",
        icon="question",
        title="Confirm Close"
    )
...
def show_about_info():
    messagebox.showinfo(
        title="About",
        message="My first text editor is made while learning about tkinter. Do you like it? Reach out on Twitter or "
                "LinkedIn and let me know @agustinromeo"
    )


root = tk.Tk()
root.title("My first text editor")
...
file_menu.add_command(label="Close", command=confirm_quit, accelerator="Ctrl+X")
...
root.bind("<KeyPress>", check_for_changes)
